...
import { Card, Button, CardHeader, CardFooter, CardDeck, CardImg, CardSubtitle, CardBody, CardTitle, CardText, Row, Col, Badge } from 'reactstrap';
...
export default class Projects extends Component{
    ...
    projectDataSet = [
        {  
            ...
            "startDate":"2018.03",
            "endDate":"2018.12",
            "summary":"위성 정보 모니터링 기능을 제공하는 웹 어플리케이션을 개발했습니다.",
            "imgs":[
                {
                    "imgName":"p1.png",
        ...
        {  
            ...
            "startDate":"2018.04",
            "endDate":"2018.06",
            "summary":"Spring MVC 교육 과정 중 수행된 팀 프로젝트로 블랙잭 게임을 개발 했습니다.",
            "imgs":[
                {
                    "imgName":"p2_1.png",
                    "caption":"로그인 화면"
        ...
        {  
            ...
            "startDate":"2017.12",
            "endDate":"2018.02",
            "summary":"(주)쎄트렉아이 인턴 기간 동안 수행한 프로젝트 입니다. Jira와 연동해 사원들의 업무 내용을 확인하고, 주간 및 월간 평가를 할 수 있는 웹 어플리케이션을 개발했습니다.",
            "imgs":[
                {
                "imgName":"p3_1.png",
